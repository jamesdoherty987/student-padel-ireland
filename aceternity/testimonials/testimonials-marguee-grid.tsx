...
export function TestimonialsMarqueeGrid() {
  return (
    <div className="relative mx-auto h-full w-full max-w-7xl overflow-hidden px-4 pt-20 md:px-8">
      <div className="pb-20">
        <h1 className="pt-4 text-lg font-bold text-black md:text-2xl dark:text-white">
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "group mx-4 h-full min-h-[230px] max-w-md rounded-xl bg-gray-50 p-4 shadow-[2px_4px_16px_0px_rgba(248,248,248,0.06)_inset] md:max-w-lg md:p-8 dark:bg-neutral-900",
        className,
      )}
    >
      {children}
