  ...
  const stats = [
    {
      ...
      content: (
        <div className="flex flex-col">
          ...
          <p className="mt-4 mb-8 text-neutral-600 dark:text-neutral-300">
...
export const StatsForChangelogDesktop = ({ stats }: { stats: Stats[] }) => {
  ...
  return (
    <div className="mx-auto hidden w-full max-w-7xl px-4 md:px-8 lg:block">
      ...
      <div className="relative mt-4 w-full overflow-hidden [mask-image:linear-gradient(to_right,transparent,white_2%,white_98%,transparent)] px-10">
